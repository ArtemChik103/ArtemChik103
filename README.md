...
Разрабатываю высоконагруженные веб-сервисы, мобильные приложения и ML-системы на стыке **Computer Vision, RAG / LLM, Deep Learning и Fullstack Web**. Превращаю сложные алгоритмы машинного обучения в готовые, масштабируемые продукты с удобным UI и продакшен-архитектурой.
...
* 👁️ **[Sonar / blind](https://github.com/ArtemChik103/blind)** — Ассистивное мобильное приложение на Flutter для незрячих. Распознавание объектов в реальном времени (EfficientDet Lite0 в фоновом Isolate), spatial TTS & haptics.
