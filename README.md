# Привет, я Артём (pechkurofff)!

### Fullstack & AI / ML Software Engineer

Разрабатываю мобильные, веб-сервисы и ML-системы на стыке **Computer Vision, RAG / LLM, Deep Learning и Fullstack Web**. Большое внимание уделяю архитектуре, чистым решениям и удобному UI интерфейсов.
...
![TensorFlow TFLite](https://img.shields.io/badge/TFLite-FF6F00?style=for-the-badge&logo=tensorflow&logoColor=white)
![FastEmbed](https://img.shields.io/badge/FastEmbed%2FONNX-00599C?style=for-the-badge&logo=onnx&logoColor=white)
...
* **[ITmed](https://github.com/ArtemChik103/ITmed)** ([Live App](https://pvjjwzapucy4re6bakgfza.streamlit.app/)) — AI MedTech платформа анализа DICOM-снимков суставов (ResNet-50 + MONAI keypoints, FastAPI, Streamlit).
...
* **[hakaton](https://github.com/ArtemChik103/hakaton)** ([Live App на Vercel](https://frontend-nine-nu-59.vercel.app)) — Веб-приложение хакатона для IT-платформы (Vue.js).
